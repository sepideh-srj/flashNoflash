...
class Pix2PixModel(BaseModel):
    ...
    def backward_D(self):
        ...
        fake_AB = torch.cat((self.real_A, self.network_output),
    ...
    def backward_G(self):
        ...
        fake_AB = torch.cat((self.real_A, self.network_output), 1)
        pred_fake = self.netD(fake_AB)
        self.loss_G_GAN = self.criterionGAN(pred_fake, True)
        # Second, G(A) = B

        self.loss_G_L1 = self.criterionL1(self.network_output, self.real_B) * self.opt.lambda_L1
        # combine loss and calculate gradients
