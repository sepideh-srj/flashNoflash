...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr2', type=float, default=0.000001, help='initial learning rate for adam')
        parser.add_argument('--lr3', type=float, default=0.000002, help='initial learning rate for adam')
