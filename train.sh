...
srun --qos=overcap python train.py --dataroot /project/aksoy-lab/Sepideh/data_big --name  cycle_toambient_lr2_mahdi_resnet12_linear_newData_mahdi_512_random_fix1 --model cycle_pix2pix_lab --direction AtoB --display_id -1 --dataset_mode greatrandom --midas 1 --midas_normal 0 --midas_flash 0 --lambda_comp 0 --random 0 --netG resnet_12blocks --D_flash 1 --lambda_color_uv 0
