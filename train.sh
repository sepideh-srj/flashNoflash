...
#srun --qos=overcap python train.py --dataroot /project/aksoy-lab/Sepideh/data --name  cycle_toambient_lr2_mahdi_resnet12_linear_newData_withoutratio2 --model cycle_pix2pix_lab --direction AtoB --display_id -1 --dataset_mode alignedlab --midas 0 --midas_normal 0 --midas_flash 0 --lambda_comp 0 --random 0 --netG resnet_12blocks --D_flash 0 --lambda_color_uv 0
srun --qos=overcap python test.py --dataroot /project/aksoy-lab/Sepideh/data --name cycle_toambient_lr2_mahdi_resnet12_linear_midas_normal2 --model cycle_pix2pix_lab --direction AtoB --dataset_mode midas --midas 0 --midas_normal 1 --random 0  --lambda_comp 0 --netG resnet_12blocks