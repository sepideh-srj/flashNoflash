...
#srun --qos=overcap python train.py --dataroot /project/aksoy-lab/Sepideh/data --name  cycle_toambient_lr2_mahdi_resnet12_linear_Dflash2 --model cycle_pix2pix_lab --direction AtoB --display_id -1 --dataset_mode alignedlab --midas 0 --midas_normal 0 --midas_flash 0 --lambda_comp 0 --random 0 --netG resnet_12blocks --D_flash 1 --lambda_color_uv 0
