import argparse
import os
from depthmerge.util import util
import torch
import depthmerge.models
import depthmerge.data
...
class BaseOptions():
    ...
    def gather_options(self):
        ...
        model_option_setter = depthmerge.models.get_option_setter(model_name)
        parser = model_option_setter(parser, self.isTrain)
        opt, _ = parser.parse_known_args()  # parse again with new defaults

        # modify dataset-related parser options
        dataset_name = opt.dataset_mode
        dataset_option_setter = depthmerge.data.get_option_setter(dataset_name)
